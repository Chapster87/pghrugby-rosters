...
This set of guidelines outlines the preferred approach for creating and styling components in the Hydrow site project. It focuses on component organization, CSS modules usage, spacing conventions, and layout preferences.
